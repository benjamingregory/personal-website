...
- **[admin/](admin/)** — admin.benjaminrgregory.com. Private metrics dashboard pulling basic usage from the inrole / kasava / monroe Postgres databases and PostHog analytics. Guidance in [admin/CLAUDE.md](admin/CLAUDE.md).
