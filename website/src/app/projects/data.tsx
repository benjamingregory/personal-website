...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    body: "Inrole evaluates job descriptions against your profile, generates tailored CVs, drafts outreach for LinkedIn and email, and ranks warm intros from your network. A Mastra-orchestrated multi-agent system runs evaluation workflows with bounded concurrency and only commits to a polished PDF for the matches it scores highly.",
    site: "inrole.xyz",
    link: "https://inrole.xyz",
    primaryStack: [
      "Next.js 16",
      "Mastra",
      "Anthropic",
    ...
    media: {
      ...
      altPrefix: "Inrole",
      alts: {
        hero: "Inrole pipeline board grouping roles by stage from evaluated through offer",
        "2": "Inrole pipeline list view sorted by match score",
        "3": "Inrole warm intros grouped by company with connection counts",
        "4": "Inrole role detail with CV match breakdown against the job description",
      },
    },
  },
  {
